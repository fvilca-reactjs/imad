...
import imagen1 from '../images/scanning.jpeg'
import imagen2 from '../images/topografia.png'
import imagen3 from '../images/planos.jpeg'
import imagen4 from '../images/modelamiento.jpeg'
import imagen5 from '../images/calculo.jpeg'
  ...
  return (
    <div className="ingenieria-page">
      ...
      <section id="ingenieria--list">
        ...
        <Card2BoxReverse image={imagen2} title={'TOPOGRAFÍA'} number='2'>
        ...
        <Card2Box image={imagen3} title={'PLANOS PARA FABRICACIÓN Y MONTAJE.'} number='3'>
        ...
        <Card2BoxReverse image={imagen4} title={'MODELAMIENTO 3D'} number='4'>
        ...
        <Card2Box image={imagen5} title={'CÁLCULO ESTRUCTURAL Y SIMULACIÓN'} number='5'>
